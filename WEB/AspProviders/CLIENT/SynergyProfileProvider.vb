...
Public NotInheritable Class SynergyProfileProvider
    ...
    Private eventSource As String = "SynergyProfileProvider"
    ...
    Public Overrides Sub Initialize(ByVal name As String, ByVal config As NameValueCollection)
        ...
        If name Is Nothing OrElse name.Length = 0 Then _
         name = "SynergyProfileProvider"

        If String.IsNullOrEmpty(config("description")) Then
            config.Remove("description")
            config.Add("description", "Synergy ASP.NET Profile provider")
        End If
    ...
    Private Function GetStockSymbols(ByVal username As String, ByVal isAuthenticated As Boolean) As ArrayList
    ...
    Private Sub SetStockSymbols(ByVal uniqueID As Integer, ByVal stocks As ArrayList)
        Dim conn As OdbcConnection = New OdbcConnection(connectionString)
    ...
    Private Function GetZipCode(ByVal username As String, ByVal isAuthenticated As Boolean) As String
    ...
    Private Sub SetZipCode(ByVal uniqueID As Integer, ByVal zipCode As String)
    ...
    Private Function GetUniqueID(ByVal username As String, ByVal isAuthenticated As Boolean, _
    ByVal ignoreAuthenticationType As Boolean) As Integer
