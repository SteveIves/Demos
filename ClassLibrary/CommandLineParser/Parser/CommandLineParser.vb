...
Public Enum CommandTypeEnum
	Filespec = 1			' a file specification, such as "*.txt"
	ShortDateString = 2		' a short date string, e.g. 08/12/2002
	LongDateString = 3		' a long date string, e.g. 08/12/2002 12:00:01 AM 
	Value = 4				' any string value
	RegExpression = 5		' text validated with a regular expression
	Flag = 6				' a value treated as an single or multiple character option that must be preceded by "/" or "-"
	ExistingFile = 7		' a file that must already exist
End Enum
