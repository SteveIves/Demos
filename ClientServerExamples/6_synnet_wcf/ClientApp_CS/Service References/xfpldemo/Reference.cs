...
namespace ClientApp.xfpldemo {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="xfpldemo.ISynergyServer")]
    public interface ISynergyServer {
        ...
        System.Collections.Generic.List<ClientApp.xfpldemo.Contact> GetCustomerContacts(int a_customer_id);
        ...
        ClientApp.xfpldemo.Method_status GetContactForUpdate(out ClientApp.xfpldemo.Contact a_contact, out byte[] a_grfa, out string a_message, int a_customer_id, int a_contact_id);
        ...
        ClientApp.xfpldemo.Method_status UpdateContact(ref ClientApp.xfpldemo.Contact a_contact, ref byte[] a_grfa, out string a_message);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ISynergyServerChannel : ClientApp.xfpldemo.ISynergyServer, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class SynergyServerClient : System.ServiceModel.ClientBase<ClientApp.xfpldemo.ISynergyServer>, ClientApp.xfpldemo.ISynergyServer {
        ...
        public System.Collections.Generic.List<ClientApp.xfpldemo.Contact> GetCustomerContacts(int a_customer_id) {
            return base.Channel.GetCustomerContacts(a_customer_id);
        }
        
        public ClientApp.xfpldemo.Method_status GetContactForUpdate(out ClientApp.xfpldemo.Contact a_contact, out byte[] a_grfa, out string a_message, int a_customer_id, int a_contact_id) {
            return base.Channel.GetContactForUpdate(out a_contact, out a_grfa, out a_message, a_customer_id, a_contact_id);
        }
        
        public ClientApp.xfpldemo.Method_status UpdateContact(ref ClientApp.xfpldemo.Contact a_contact, ref byte[] a_grfa, out string a_message) {
