<CODEGEN_FILENAME><StructureName>Service.dbl</CODEGEN_FILENAME>
...
namespace <NAMESPACE>
    ...
    public method ReadAll<StructureName>s, MethodStatus
		...
		proc
			...
			begin
				data api, @<API_CLASS>, new <API_CLASS>()
				completionSource.SetResult(Tuple.Create(api.UpdatePart(tmp<StructureName>,tmpGrfa),tmp<StructureName>,tmpGrfa))
			end
			this.ServiceDispatcher.Dispatch(curryParams)
			completionSource.Task.Wait()
