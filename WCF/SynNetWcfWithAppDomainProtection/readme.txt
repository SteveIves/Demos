...
Title:			SynNetWcfWithAppDomainProtection
...
This example includes two Synergy .NET Visual Studio Solutions:

	* PartsSystemServer.sln			Server environment (WCF service)
	* PartsSystemClient.sln			Client environment (WPF client)

To run the example code you should start two seperate instances of Visual
Studio, and then open both of the solutions.

IMPORTANT: The instance of Visual Studio that is used to open and run the
server application MUST be "Run as Administrator". If you don't do this then
the server application will fail to start because it won't have permissions
to bind to your network adapter.

================================================================================
PartsSystemServer AppDomainProtection Project
...
================================================================================
PartsSystemServer PartsSystem Project
...
================================================================================
PartsSystemServer WcfServiceLibrary Project
...
================================================================================
PartsSystemServer ServiceHost Project
...
================================================================================
PartsSystemClient TestClient Project
