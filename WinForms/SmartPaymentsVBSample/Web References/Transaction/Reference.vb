...
Namespace Transaction
    ...
    Partial Public Class SmartPayments
        ...
        Public Sub New()
            MyBase.New
            Me.Url = "http://demo.tpisoft.com/smartpayments/transact.asmx"
        ...
        '''<remarks/>
        Public Function BeginProcessCreditCard( _
                    ...
                    ByVal CVNum As String,  _
                    ByVal ExtData As String,  _
                    ByVal callback As System.AsyncCallback,  _
                    ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("ProcessCreditCard", New Object() {UserName, Password, TransType, CardNum, ExpDate, MagData, NameOnCard, Amount, InvNum, PNRef, Zip, Street, CVNum, ExtData}, callback, asyncState)
        End Function
        
        '''<remarks/>
        Public Function EndProcessCreditCard(ByVal asyncResult As System.IAsyncResult) As Response
        ...
        '''<remarks/>
        Public Function BeginProcessDebitCard( _
                    ByVal UserName As String,  _
                    ByVal Password As String,  _
                    ByVal TransType As String,  _
                    ByVal CardNum As String,  _
                    ...
                    ByVal callback As System.AsyncCallback,  _
                    ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("ProcessDebitCard", New Object() {UserName, Password, TransType, CardNum, ExpDate, MagData, NameOnCard, Amount, InvNum, PNRef, Pin, RegisterNum, SureChargeAmt, CashBackAmt, ExtData}, callback, asyncState)
        End Function
        
        '''<remarks/>
        Public Function EndProcessDebitCard(ByVal asyncResult As System.IAsyncResult) As Response
            Dim results() As Object = Me.EndInvoke(asyncResult)
            Return CType(results(0),Response)
        End Function
        ...
        '''<remarks/>
        Public Function BeginProcessEBTCard( _
                    ByVal UserName As String,  _
                    ByVal Password As String,  _
                    ByVal TransType As String,  _
                    ByVal CardNum As String,  _
                    ...
                    ByVal callback As System.AsyncCallback,  _
                    ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("ProcessEBTCard", New Object() {UserName, Password, TransType, CardNum, ExpDate, MagData, NameOnCard, Amount, InvNum, PNRef, Pin, RegisterNum, SureChargeAmt, CashBackAmt, ExtData}, callback, asyncState)
        End Function
        
        '''<remarks/>
        Public Function EndProcessEBTCard(ByVal asyncResult As System.IAsyncResult) As Response
            Dim results() As Object = Me.EndInvoke(asyncResult)
            Return CType(results(0),Response)
        End Function
        ...
        '''<remarks/>
        Public Function BeginProcessGiftCard(ByVal UserName As String, ByVal Password As String, ByVal TransType As String, ByVal CardNum As String, ByVal ExpDate As String, ByVal MagData As String, ByVal Amount As String, ByVal InvNum As String, ByVal PNRef As String, ByVal ExtData As String, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("ProcessGiftCard", New Object() {UserName, Password, TransType, CardNum, ExpDate, MagData, Amount, InvNum, PNRef, ExtData}, callback, asyncState)
        End Function
        
        '''<remarks/>
        Public Function EndProcessGiftCard(ByVal asyncResult As System.IAsyncResult) As Response
            Dim results() As Object = Me.EndInvoke(asyncResult)
            Return CType(results(0),Response)
        End Function
        ...
        '''<remarks/>
        Public Function BeginProcessCheck( _
                    ByVal UserName As String,  _
                    ByVal Password As String,  _
                    ByVal TransType As String,  _
                    ...
                    ByVal callback As System.AsyncCallback,  _
                    ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("ProcessCheck", New Object() {UserName, Password, TransType, CheckNum, TransitNum, AccountNum, Amount, MICR, NameOnCheck, DL, SS, DOB, StateCode, CheckType, ExtData}, callback, asyncState)
        End Function
        
        '''<remarks/>
        Public Function EndProcessCheck(ByVal asyncResult As System.IAsyncResult) As Response
            Dim results() As Object = Me.EndInvoke(asyncResult)
            Return CType(results(0),Response)
        End Function
        ...
        '''<remarks/>
        Public Function BeginGetInfo(ByVal UserName As String, ByVal Password As String, ByVal TransType As String, ByVal ExtData As String, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("GetInfo", New Object() {UserName, Password, TransType, ExtData}, callback, asyncState)
        End Function
        
        '''<remarks/>
        Public Function EndGetInfo(ByVal asyncResult As System.IAsyncResult) As Response
            Dim results() As Object = Me.EndInvoke(asyncResult)
            Return CType(results(0),Response)
        End Function
        ...
        '''<remarks/>
        Public Function BeginProcessSignature(ByVal UserName As String, ByVal Password As String, ByVal SignatureType As String, ByVal SignatureData As String, ByVal PNRef As String, ByVal Result As String, ByVal AuthCode As String, ByVal ExtData As String, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("ProcessSignature", New Object() {UserName, Password, SignatureType, SignatureData, PNRef, Result, AuthCode, ExtData}, callback, asyncState)
        End Function
        
        '''<remarks/>
        Public Function EndProcessSignature(ByVal asyncResult As System.IAsyncResult) As Response
            Dim results() As Object = Me.EndInvoke(asyncResult)
            Return CType(results(0),Response)
        End Function
