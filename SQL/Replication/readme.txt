...
If you wish to actually configure and execute this demo you will need:
  ...
  - Build everything. In Workbanch:
        - Make the LIBRARY project active and then do a BUILD
        - Make the REPLICATOR project active and then do a BUILD
        - Make the APPLICATION project active and then do a BUILD
...
To start the replicator process, select "Replicator -> Start Replicator" from
the application menu. You should see some messages, including:
