...
{
    /// <summary>
    /// A utility class which can be used in a View to facilitate associating an event of
    /// an element in the View to be associated with an ICommand in a ViewModel. This technique
    /// is used to avoid the necessity for code-behind event handlers in Views.
    /// </summary>
