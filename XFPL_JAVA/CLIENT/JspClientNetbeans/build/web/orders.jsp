<%@page contentType="text/html" pageEncoding="UTF-8" import="java.util.ArrayList,java.util.Date,java.text.DateFormat" %>
...
<%
	...
	SynergyApp.Order_header thisOrder;

	for (cnt=0; cnt<orderCount; cnt++) {

		thisOrder = (SynergyApp.Order_header)order.get(cnt);
